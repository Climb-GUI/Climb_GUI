...
class Global_State(State):
    ...
    async def handle_upload(
        ...
        for file in files:
            ...
            colors(outfile, self.color, file.filename)
...
def start():
    ...
    return rx.box(
        ...
        rx.input(placeholder="Enter the color of the holds you wish to climb", on_blur=Global_State.set_color),
        rx.button(
            "Upload",
        ...
        rx.foreach(
            ...
            lambda names, index: rx.vstack(
                rx.cond(
                    ...
                    rx.image(src=f"{Global_State.names[index]}", width="100%"),
